...
public class AlumnosDAO {
    ...
    public ResultadoTO guardarAlumno(AlumnosTO alumnos){
        ...
        try {
            ...
            res.setExito(false);
            System.out.println("Hubo un problema al guardar... Por favor reintentar nuevamente o contacte con el administrador");
    ...
    public ResultadoTO eliminarAlumno(AlumnosTO alumnos){
        ...
        try {
            ...
            System.out.println("Hubo un problema al borrar... Por favor reintentar nuevamente.");
    ...
    public ResultadoTO buscarCurpAlumno(String curp, String mensaje){
        ...
        try {
            ...
            System.out.println("Hubo un problema al buscar el curp... Por favor reintentar nuevamente.");
            System.out.println("-Detalles-");
        }
        return res;
    }
